...
export default function Settings() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "40px auto", padding: 24 }}>
      ...
      <form onSubmit={handleSave} style={{ background: '#fff', borderRadius: 18, boxShadow: '0 2px 16px #0001', padding: 40, maxWidth: 600, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 32 }}>
        <div>
